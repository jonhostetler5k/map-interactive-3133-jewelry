...
const App: React.FC = () => {
  ...
  // Debug log to verify the component is loading with new code
  useEffect(() => {
    console.log('App loaded with collapsible navigation v2.0');
    console.log('Playbook subsections configured:', PLAYBOOK_SUBSECTIONS.length);
  }, []);
      ...
      >
        <div className="p-8">
          ...
          <div className="flex flex-col mb-12">
            ...
            <p className="text-[8px] text-green-500 mt-2">✓ Nav v2.0 Loaded</p>
          </div>
